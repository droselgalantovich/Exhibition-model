    ...
    return (
        <div className='w-[3592px] h-[1595px] flex flex-row justify-start m-auto mt-[146px]'>
            ...
            <div className='absolute mt-[50px]'>
                <p className='text-extraBig font-bold leading-[100%] w-[936px] ml-[105px]'>
                    Объектовый<br/>узел связи
                </p>
                <img className='w-[851px] ml-[35px] h-[1093px] mt-[27px]' src='/images/ConnectingServer.png' alt=''/>
                <Link to='/ModelsSmallATC'
                      className='border-2 border-black rounded-[60px] w-[936px] h-[189px] flex justify-between p-[45px] items-center mt-[45px]'>
