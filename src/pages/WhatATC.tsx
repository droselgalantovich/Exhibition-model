    ...
    <div className='p-8'>
        ...
        <div className='mt-[27px] flex justify-center'>
            <div className='w-[1020px] m-[100px]'>
                <img className='size-[182px] m-auto' src='/images/CheckCircleOutlined.png' alt='' />
                <p className='text-extra text-deep-blue mt-[30px] text-center'>
                    Стабильность, которой можно<br></br>
                    доверять
                </p>
        ...
        <div onClick={() => setIsModalOpen(true)} className='mr-[150px] border-2 border-black rounded-[60px] w-[1050px] h-[240px] float-right flex justify-between p-[45px]'>
            <p className='text-extra font-medium justify-center'>Как это поможет<br></br>вашему бизнесу?</p>
            <img className='h-[114px] w-[70px] pt-[15px] pb-[15px] mr-[80px]' src='/images/round_right.png' alt='' />
        </div>
        ...
        >
            ...
            <div className='w-[2330px] h-[984px] flex items-center justify-start mt-[117px]'>
                <div className='flex'>
                    <img className='w-[78px] h-[78px]' src='/images/CheckCircleOutlined.png' alt='' />
                    <div className='w-[596px]'>
                        <div>
                            Вы предоставите удобный инструмент коммуникации вашим сотрудникам
                        </div>
                        <div>
                            Создавайте единое коммуникационное пространство: совмещайте звонки, видеоконференции и совместную работу над документами в один технологический контур. Это даёт возможность удерживать фокус на критически важных проектах и сокращать сроки принятия решений.
                        </div>
                    </div>
                </div>
            </div>
